  ...
  return (
    <Layout hasTabBar title="동네생활">
      <div className="py-16 px-4 space-y-8">
        {[1, 2, 3, 4, 5].map((_, i) => (
          <div key={i} className="flex flex-col items-start cursor-pointer">
            ...
            <div className="mt-2 text-gray-700">
              <span className="text-[#A191E4] font-medium mr-2">Q.</span>
        ...
        <button className="fixed hover:bg-[#A191E4] transition-colors cursor-pointer bottom-24 right-5 shadow-xl bg-purple-300 rounded-full p-3 text-white">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
