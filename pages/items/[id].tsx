    ...
    <Layout canGoBack>
      ...
      <div className="mb-8">
        ...
        <div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
          <div className="w12 h12 rounded-full bg-slate-300" />
          <div>
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-[#A191E4] text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 font-medium hover:bg-purple-400 focus:ring-purple-400 ">
              Talk to seller
            </button>
